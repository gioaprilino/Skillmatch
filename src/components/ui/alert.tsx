...
>(({ className, variant = 'default', ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      {
        'border-l-4 border-l-destructive bg-destructive/10 text-destructive': variant === 'destructive',
        'border-l-4 border-l-primary bg-primary/10 text-primary': variant === 'default',
      },
      className
    )}
    {...props}
