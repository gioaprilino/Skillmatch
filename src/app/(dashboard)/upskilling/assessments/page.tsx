          ...
          <div className="relative z-10 max-w-3xl space-y-3">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-3">
              <div className="p-3 rounded-xl bg-card/80 border border-border">
                ...
                <p className="text-xl font-bold text-foreground mt-0.5">{assessments.length || 8} Modul</p>
              </div>
              <div className="p-3 rounded-xl bg-card/80 border border-border">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {loading ? (
            Array.from({ length: 6 }).map((_, i) => (
              <div
                key={i}
                className="h-72 rounded-2xl border border-border bg-card/60 p-6 flex flex-col justify-between animate-pulse"
              >
